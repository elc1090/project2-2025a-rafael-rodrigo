...
function ExerciseCard({ exercise, onFavoriteToggle, isFavorite }) {
    ...
    return (
        <div style={{ position: 'relative', border: '1px solid #ccc', borderRadius: '8px', overflow: 'hidden', display: 'flex', flexDirection: 'column', height: '320px', textAlign: 'center' }}>
            <button 
            ...
            <Link to={`/exercise/${exercise.id}`} style={{ textDecoration: 'none', color: 'inherit', flexGrow: 1 }}>
